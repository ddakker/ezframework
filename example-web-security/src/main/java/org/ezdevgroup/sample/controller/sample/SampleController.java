...
import org.ezdevgroup.sample.security.UserDetailsHelper;
...
public class SampleController {
	...
	public String security(Model model, Principal principal, HttpServletRequest request) {
	...
	@RequestMapping(value = "bind/vali", method = { RequestMethod.GET })
