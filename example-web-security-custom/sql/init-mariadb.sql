...
(
	...
	USER_TYPE  INT NOT NULL  DEFAULT 1001 comment '사용자타입',
...
INSERT IGNORE INTO `EZ_USER` (`USER_ID`, `USER_TYPE`, `USER_NM`, `USER_PWD`, `USE_YN`) VALUES
...
INSERT IGNORE INTO `ACL_AUTH` (`AUTH_CD`, `AUTH_NM`, `AUTH_DC`, `REG_DT`, `MODI_DT`) VALUES
...
INSERT IGNORE INTO `ACL_RESOURCE` (`RESOURCE_CD`, `RESOURCE_NM`, `RESOURCE_DC`, `RESOURCE_URL`, `REG_DT`, `MODI_DT`) VALUES
...
INSERT IGNORE INTO `ACL_USER_AUTH` (`USER_AUTH_KEY`, `AUTH_CD`, `REG_DT`, `MODI_DT`) VALUES
...
INSERT IGNORE INTO `ACL_AUTH_RESOURCE` (`AUTH_CD`, `RESOURCE_CD`, `REG_DT`, `MODI_DT`) VALUES
...
INSERT IGNORE INTO `ACL_AUTH_HIERARCHY` (`SEQ`, `PARENT_AUTH_CD`, `CHILD_AUTH_CD`) VALUES
