package org.ezdevgroup.ezframework.security.web;
...
public class EzSecurityControllerAdvice {
    ...
    public ModelAndView handleAccessDeniedException(AccessDeniedException ex) {
		ModelAndView mv = new ModelAndView(globalProperties.getProperty("view.jsp.notauth"));
        mv.addObject(globalProperties.getProperty("content.key.result.code"), globalProperties.getProperty("content.value.notauth"));
    ...
    public ModelAndView handleBadCredentialsException(BadCredentialsException ex) {
		ModelAndView mv = new ModelAndView(globalProperties.getProperty("view.jsp.failauth"));
        mv.addObject(globalProperties.getProperty("content.key.result.code"), globalProperties.getProperty("content.value.badcreden"));
        mv.addObject(globalProperties.getProperty("content.key.result.message"), ex.getMessage());
        return mv;
    }
}
