...
public class EzSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException,
		...
		try {
			...
			String redirectUri = ((HttpServletRequest) request).getContextPath() + globalProperties.getProperty("page.login.form.url");
			...
			if (e.getMessage().contains("org.apache.tiles.request.render.CannotRenderException") ||
				...
				log.error("view.jsp.error: {}", globalProperties.getProperty("page.error.500.url"));
				redirectUri = globalProperties.getProperty("page.error.500.url");
