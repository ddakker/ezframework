...
public class HttpClientCase {
	...
	public void test_euckr() throws Exception {
        ...
        HttpGet httpget = new HttpGet("http://ez1.local.ezwel.com/common/auth/userSessionTest.ez?test2=한글&test22=en");
        ...
        HttpPost httpost = new HttpPost("http://ez1.local.ezwel.com/common/auth/userSessionTest.ez?test2=한글&test22=en");
