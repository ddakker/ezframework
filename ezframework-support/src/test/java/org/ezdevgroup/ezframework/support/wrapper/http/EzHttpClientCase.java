...
public class EzHttpClientCase {
	...
	public void test404_에러_페이지() {
		...
		http.setUrl("http://test.ezdevgroup.org/adfasdf");
	...
	public void testSession_세션_유지() {
		...
		statusCode = http.send("http://shop.ezdevgroup.org/shopNew/main/mainFstDepth.ez");
		System.out.println("http.getStatusCode(): " + statusCode);
	...
	public void testSession_세션_유지test() {
		...
		params.put("back_url", "http%3A%2F%2Fverify.ezdevgroup.org%2Fredmine%2Faccount%2Fregister");
	...
	public void testCookieSetGet_쿠키_설정_및_가져오기() {
		...
		cookie.setDomain(".ezdevgroup.org");
		cookies.addCookie(cookie);

		EzHttpClient http = new EzHttpClient();
		http.setUrl("http://intranet.ezdevgroup.org/zbxe/?document_srl=161206");
		...
		http.setUrl("http://ezcafe.ezdevgroup.org/login/loginAction.ez?userBean.cookieSaveYn=on&userBean.userId=20111085&userBean.userPwd=lee1474");
