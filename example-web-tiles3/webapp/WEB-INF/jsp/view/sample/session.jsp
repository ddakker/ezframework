...
<table border=1 bordercolor="gray" cellspacing=1 cellpadding=0
        ...
        <form action="/sample/session/add">
        <tr bgcolor="cyan">
                <td colspan=2 align="center"><b>Session add key/value</b></td>
        </tr>
        <tr>
                <th>key</th>
                <th>value</th>
        ...
        <tr>
                <td align="center"><input type="text" name="key" style="width: 100%"></td>
                <td align="center"><input type="text" name="value" style="width: 100%"></td>
        </tr>
        <tr>
                <td colspan=2 align="center"><input type="submit" value="Session Add"> </td>
        </tr>
        </form>
        <tr bgcolor="cyan">
        ...
        %>
<div>
        <a href="/sample//session/logout">logout</a>
</div>
</body>
</html>
