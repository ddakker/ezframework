...
public class MultipartHelper {
	...
	public static String getUploadTempDir(HttpServletRequest request) {
		String tempUploadDir = WebApplicationContextUtils.getRequiredWebApplicationContext(request.getServletContext()).getBean("globalsProperties", GlobalsProperties.class).getProperty("upload.temp.dir");
